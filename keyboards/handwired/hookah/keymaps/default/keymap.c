...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //   KC_TAB,  KC_SLSH, KC_COMM, KC_DOT,  KC_P,    KC_Y, vv   KC_F,    KC_G,    KC_C,    KC_R,    KC_L,    KC_BSPC,
  ...
  // ),tttttooo.....bbbbb.......tttgggbbbmmmnnnbbbyyyhhnnnmmmjjjuuiiikk,,ol..           zzzzaaaqqqwwsssxxeeddccrrffvvvvvvvTTTTT
